...
import com.example.newsapp.rest.response.Status.ERROR
import com.example.newsapp.rest.response.Status.LOADING
import com.example.newsapp.rest.response.Status.NO_MORE_ITEM
import com.example.newsapp.rest.response.Status.SUCCESS
